'''
AI Fitness Tracker — Main Streamlit Application
    ...
    if not cap.isOpened():
        ...
        while st.session_state.running:
            ...
            if landmarks:
                ...
                # Draw HUD overlay
                frame = draw_hud(frame, reps, sets, score, stage, exercise, target_reps, target_sets)

                # Calories (rough estimate)
                elapsed = time.time() - st.session_state.start_time
                st.session_state.calories = estimate_calories(exercise, reps, sets, elapsed)
